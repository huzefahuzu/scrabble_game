...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { game_id: @participant.game_id, player_id: @participant.player_id, score: @participant.score } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { game_id: @participant.game_id, player_id: @participant.player_id, score: @participant.score } }
